...
def test_create_course(
    ...
    create_course_page.chek_visible_exercises_title()
    create_course_page.check_visible_create_exercise_button()
    create_course_page.chek_visible_exercises_empty_view()

    create_course_page.upload_preview_image("./testdata/files/hnKae5PWTG4.jpeg")
    create_course_page.check_visible_image_upload_view(is_uploaded_image=True)
